...
namespace DDCRM.Core.Persistence.Migrations
{
    ...
    [Migration("20260506171428_AddIntegrationInstancesV15")]
    partial class AddIntegrationInstancesV15
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DDCRM.Core.Persistence.Entities.IntegrationWorkerRuntimeOutboxEntity", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "IntegrationKey", "RuntimeAccountId", "Operation");
            ...
            modelBuilder.Entity("DDCRM.Core.Persistence.Entities.ProjectIntegrationWorkerRuntimeEntity", b =>
                {
                    ...
                    b.Property<string>("ConfigurationCiphertext")
                        .HasColumnType("text");

                    b.Property<DateTimeOffset?>("ConfigurationUpdatedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("InstanceDisplayName")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.HasIndex("ProjectId", "IntegrationKey", "Id")
                        .IsUnique();

                    b.HasIndex("ProjectId", "IntegrationKey", "IsDefault")
                        .HasDatabaseName("IX_project_integration_worker_runtimes_ProjectId_IntegrationK~1");
